...
// private final ProductDeleteRepository productRepository;

// /**
// * コンストラクタインジェクションによりリポジトリを注入します。
// */
// public ProductService(ProductCategoryRepository categoryRepository,
// ProductDeleteRepository productRepository) {
...
// * @return 商品のページオブジェクト
// */
// public Page<Product> findProductsByCategory(Integer categoryId, Pageable
// pageable) {
...
// } else {
// // カテゴリで絞り込んでページング取得
// content = productRepository.findByCategoryIdWithPaging(categoryId, limit,
// offset);
